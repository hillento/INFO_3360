...
namespace StatsNinja.Controllers
{
    public class StatisticsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StatisticId,StatisticName")] Statistic statistic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StatisticId,StatisticName")] Statistic statistic)
        {
            if (ModelState.IsValid)
            {
